        ...
        <>
            <section className="py-10">
                <div className="mx-auto text-center md:max-w-xl lg:max-w-3xl">
                  <h3 className="mb-6 text-3xl font-bold">Comision Directiva</h3>
                  <p className="mb-6 pb-2 md:mb-12 md:pb-0">
                    La Comisión Directiva, que representa al Centro de Estudiantes Tecnológicos. Son la parte ejecutiva y administrativa integrada por miembros titulares que son votados por los estudiantes cada 2 años, entre candidatos de distintas agrupaciones estudiantiles.
                    <h2 className="text-start font-semibold">Te presentamos a los actuales integrantes:</h2>
                  </p>
